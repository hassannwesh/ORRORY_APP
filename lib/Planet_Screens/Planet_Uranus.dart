...
import 'package:orrery_app/Planet_Screens/Planet_Neptune.dart';
import 'package:orrery_app/Planet_Screens/Planet_Saturn.dart';

class Planet_Uranus extends StatelessWidget {
  const Planet_Uranus({super.key});
              ...
              child: Center(
                child: Stack(
                  ...
                  children: [
                    Positioned(
                      child: Image.asset(
                        'assets/Planet_Uranus.png.png', // صورة الكوكب
                        width: 290.w,
                        height: 240.h,
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                          const Planet_Saturn()), // استدعاء HomeScreen
                    );
                  },
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                          const Planet_Neptune()), // استدعاء HomeScreen
                    );
                  },

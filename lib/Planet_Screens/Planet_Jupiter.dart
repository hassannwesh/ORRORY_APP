...
class Planet_Jupiter extends StatelessWidget {
  const Planet_Jupiter({super.key});
              ...
              child: Center(
                child: Stack(
                  ...
                  children: [
                    Positioned(
                      child: Image.asset(
                        'assets/Planet_Jupiter.png.png', // صورة الكوكب
                        width: 290.w,
                        height: 240.h,
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                          const Planet_Mars()), // استدعاء HomeScreen
                    );
                  },

...
import 'package:orrery_app/Planet_Screens/Planet_Earth.dart';
import 'package:orrery_app/Planet_Screens/Planet_Mercury.dart';

import 'Planet_Jupiter.dart';

class Planet_Venus extends StatelessWidget {
  const Planet_Venus({super.key});
              ...
              child: Center(
                child: Stack(
                  ...
                  children: [
                    Positioned(
                      child: Image.asset(
                        'assets/Planet_Venus.png.png', // صورة الكوكب
                        width: 290.w,
                        height: 240.h,
              ...
              children: [
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => const Planet_Mercury()), // استدعاء HomeScreen
                    );
                  },
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => Planet_Earth()), // استدعاء HomeScreen
                    );
                  },

...
import 'package:orrery_app/Planet_Screens/Planet_Jupiter.dart';

class Planet_Mars extends StatelessWidget {
  const Planet_Mars({super.key});
              ...
              child: Center(
                child: Stack(
                  ...
                  children: [
                    Positioned(
                      child: Image.asset(
                        'assets/Planet_Mars.png.png', // صورة الكوكب
                        width: 290.w,
                        height: 240.h,
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const Planet_Earth()), // استدعاء HomeScreen
                    );
                  },
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              const Planet_Jupiter()), // استدعاء HomeScreen
                    );
                  },
                  icon:

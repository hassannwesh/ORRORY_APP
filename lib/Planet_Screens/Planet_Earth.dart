...
import 'package:orrery_app/Planet_Screens/Planet_Mars.dart';
import 'package:orrery_app/Planet_Screens/Planet_Venus.dart';

class Planet_Earth extends StatelessWidget {
  const Planet_Earth({super.key});
              ...
              child: Center(
                child: Stack(
                  ...
                  children: [
                    Positioned(
                      child: Image.asset(
                        'assets/Planet_Earth.png.png', // صورة الكوكب
                        width: 290.w,
                        height: 240.h,
              ...
              children: [
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => const Planet_Venus()), // استدعاء HomeScreen
                    );                  },
                ...
                IconButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (context) => const Planet_Mars()), // استدعاء HomeScreen
                    );                  },
